...
#define CONFIGURATION "--extra-cflags=-I/opt/PalmPDK/include/ -I/opt/PalmPDK/include/GLES2 -I/opt/PalmPDK/include/SDL -I/srv/preware/cross-compile/packages/common/freetype/build/armv7/include -I/srv/preware/cross-compile/staging/armv7/usr/include/ -I../build_libs/include -I../libiconv-1.14/lib --extra-ldflags=-L/srv/preware/cross-compile/packages/common/freetype/build/armv7/objs/.libs -L/opt/PalmPDK/device/lib/ -L/srv/preware/cross-compile/staging/armv7/usr/lib/ -L../zlib-1.2.5 -L../expat-2.0.1/.libs -L../libiconv-1.14/lib/.libs -L../build_libs/lib --extra-libs=-lGLESv2 --enable-neon --enable-gl --disable-dvdnav --disable-dvdread --disable-dvdread-internal --disable-libdvdcss-internal --disable-fontconfig --extra-cflags=-marm -march=armv7-a -ftree-vectorize -mfpu=neon -mfloat-abi=softfp -mtune=cortex-a8"
...
#define CONFIG_TIMECODE_V2_MUXER 1
